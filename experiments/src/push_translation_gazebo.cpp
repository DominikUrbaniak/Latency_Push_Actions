...
void SetWorld()
{
    ...
    /*obj.setname("translation_base");
    obj.setx(cube_x_init+0.0005);
    obj.sety(cube_y_init-0.001+0.06);
    obj.setz(0.001);//reference frame defined in the middle point
    obj.setqx(0);
    obj.setqy(0);
    obj.setqz(1);
    obj.setqw(0);
    ...
    obj.sety(3);
    obj.setz(0.025+0.01);//reference frame defined in the middle point
    obj.setqx(0);
    obj.setqy(0);
    obj.setqz(0);
    obj.setqw(1);
...
int main(int argc, char * argv[])
{
  ...
  if(theta_sol_init.size()!=0)
  {
    ...
    //init_conf_request->vc_scaler = vc_scaler;
